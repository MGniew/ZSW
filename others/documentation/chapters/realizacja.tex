...
Po uzupełnieniu źródłem w Narzędzia$->$Płytka$->$Menedżer płytek możliwe stało się odnalezienie "ESP8266 Comunity" instalujemy najnowszą wersję (w naszym przypadku 2.3.0). Po tak przygotowanym IDE możliwe było przystąpienie do pracy.
